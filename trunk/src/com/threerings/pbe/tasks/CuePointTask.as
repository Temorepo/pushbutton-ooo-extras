...
{
    public static function CueAfter (cueName :String, task :IEntityTask) :IEntityTask
    {
        return new SerialTask(task, new CuePointTask(cueName));
    }

    public static function WaitForCue (cueName :String, task :IEntityTask) :IEntityTask
    {
